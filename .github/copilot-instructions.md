# GitHub Copilot Instructions -- JP Auto-Extraction

**Template Version**: 3.0.0
**Last Updated**: February 23, 2026
**Project**: JP Auto-Extraction -- Browser-automation tool (Playwright) that extracts jurisprudence answers and citations from the JP UI using predefined legal questions.
**Path**: `C:\AICOE\eva-foundry\06-jp-auto-extraction\`
...
4. **Query the data model** for this project's record:
   `powershell
   Invoke-RestMethod "http://localhost:8010/model/projects/06-jp-auto-extraction" | Select-Object id, maturity, notes
   `
...
This file is the copilot-instructions for **06-jp-auto-extraction** (JP Auto-Extraction).
...
Once this file has been loaded, the active project is locked to **06-jp-auto-extraction** for the entire session.
...
**Name**: JP Auto-Extraction
**Folder**: `C:\AICOE\eva-foundry\06-jp-auto-extraction`
**ADO Epic**: [TODO]
**37-data-model record**: `GET /model/projects/06-jp-auto-extraction`
**Maturity**: poc
**Phase**: Phase 1 -- Playwright Automation POC

**Depends on**:
- 05-extract-cases -- [TODO: why]
...
Invoke-RestMethod "http://localhost:8010/model/endpoints/" |
  Where-Object { $_.implemented_in -like '*06-jp-auto-extraction*' } |
